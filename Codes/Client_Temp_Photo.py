...
# Fonction pour envoyer une image .jpg dès qu'elle est disponible
def send_images():
        ...
        with open(image, 'rb') as img:
            ...
            try:
                ...
                if response.status_code == 200:
                    print(f"{image} envoyé avec succès")
                else:
                    print(f"Erreur lors de l'envoi de {image} : {response.status_code}")
