...
################################Configuration######################################################################
SERVER_URL ="https://192.168.137.2:5000/upload"# URL du serveur
LOCAL_STORAGE_FILE = "data.json"  # Fichier pour stocker les données localement
ENVOI_INTERVALLE = 10  # Intervalle d'envoi en secondes (1 minute)
ARCHIVE_INTERVALLE = 20  # Intervalle d'archivage en secondes (1 heure)
NETTOYAGE_INTERVALLE = 120  # Intervalle de nettoyage en secondes (3 minutes)
